  ...
  return (
    <div className="instrument-details">
      <section className="detail-section">
        ...
        <div className="platform-name">{instrument.name}</div>
      ...
      <section className="detail-section"><ProfileChart data={profile.points} /></section>
      ...
      <section className="detail-section">
        ...
        <div className="detail-row"><span className="detail-label">Maximum depth:</span><span className="detail-value">{instrument.maxDepth} m</span></div>
